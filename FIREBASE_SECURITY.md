...
- Emision de invitaciones en app: el administrador crea una invitacion operativa asociada al correo normalizado del colaborador, y este la activa dentro de la app con ese mismo correo.
...
- El envio real de correos de invitacion es opcional; requiere instalar la extension Firebase Trigger Email o una integracion equivalente que consuma la coleccion mail.
...
6. Durante el alta por invitacion usa el mismo correo invitado; si se compartio un codigo INV-xxxxxx, sirve como referencia adicional.
7. Si quieres notificacion automatica por correo, instala Trigger Email y apunta la coleccion de salida a mail.
...
La invitacion ya funciona sin correo externo. La coleccion `mail` queda reservada para una notificacion opcional futura si se instala Trigger Email o una integracion equivalente.

## Estado actual del proyecto

- Verificado el 21-05-2026: el proyecto `auto-guardian-t` no tiene extensiones instaladas todavia.
- Resultado: la invitacion funciona desde la app sin depender de `mail`; hoy no existe un consumidor activo para notificaciones por correo.
